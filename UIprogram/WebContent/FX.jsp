...
<div align="center"><input type="submit" class='btn btn-primary' name="commit" value="Submit" onclick="form.action='FXservlet';" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit"  class='btn btn-primary' name="commit" value="Cancel" onclick="creationFailed();" ></div> 
