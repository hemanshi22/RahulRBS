...
<title>Search By Desk Type</title>
</head>
<body>
	...
	<table class="table table-hover" align="center" style="width: 800px">
		...
		<%
			try {
				String desk = request.getParameter("desk_id");
				int data;
				String checked = request.getParameter("c2");
				if (checked == null) {
					data = 0;
				} else {
				...
				int DESK_ID = Integer.parseInt(desk);
				int deskid;
				String state, branchname, deskname, areaname;
				int desk1, branch1, area, employeeid;
							...
							if (rs3.next()) {
								...
								if (branch1 == 0) {
									...
									ResultSet rs4 = statement4
											.executeQuery("select BRANCH_NAME from USER_BRANCH where BRANCH_ID =" + branch1);
									if (rs4.next()) {
